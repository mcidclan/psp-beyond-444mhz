...
## Tables
0 square indicates 333 mhz the default. The available values are the following:
...
*Note: If your PSP crashes on the high values, just set it to the number of squares that precede the crash.*

## build & install

Build the plugin using the appropriate tools, then copy and paste `opicker.prx` into your SEPLUGINS folder.
